...
/**
 * The table must store details of all nodes in the graph
 */
public class EnrichmentTableModel extends JPanel {
    // all column names that are present in the EnrichmentTableModel
    ...
    private Set canonicalNameVector;
    ...
    public EnrichmentTableModel(Set canonicalNameVector, CyNetwork currentNetwork, CyNetworkView currentNetworkview, CySwingAppAdapter adapter){
        this.adapter = adapter;
        this.originalNetwork = currentNetwork;
        this.originalNetworkView = currentNetworkview;
        this.canonicalNameVector = canonicalNameVector;
